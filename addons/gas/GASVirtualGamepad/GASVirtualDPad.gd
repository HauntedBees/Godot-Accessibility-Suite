...
@export var left_texture: Texture2D = preload("res://addons/gas/GASVirtualGamepad/Parts/dpad1.png"):
	set(t):
		left_texture = t
		if left != null:
			left.texture = t
@export var right_texture: Texture2D = preload("res://addons/gas/GASVirtualGamepad/Parts/dpad2.png"):
	set(t):
		right_texture = t
		if right != null:
			right.texture = t
@export var up_texture: Texture2D = preload("res://addons/gas/GASVirtualGamepad/Parts/dpad0.png"):
	set(t):
		up_texture = t
		if up != null:
			up.texture = t
@export var down_texture: Texture2D = preload("res://addons/gas/GASVirtualGamepad/Parts/dpad3.png"):
	set(t):
		down_texture = t
		if down != null:
			down.texture = t
...
func _position_directions():
	...
	for i in [left, right, up, down]: i.position += size / 2.0
