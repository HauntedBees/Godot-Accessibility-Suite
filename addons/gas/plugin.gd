...
func _enter_tree():
	...
	add_custom_type("GASRichTextLabel", "RichTextLabel", load("res://addons/gas/GASRichTextLabel.gd"), get_editor_interface().get_base_control().get_icon("Button", "EditorIcons"))
	add_custom_type("GASContainer", "Control", load("res://addons/gas/GASContainer.gd"), get_editor_interface().get_base_control().get_icon("GridContainer", "EditorIcons"))
	add_custom_type("GASVirtualGamepad", "Control", load("res://addons/gas/GASVirtualGamepad/GASVirtualGamepad.gd"), get_editor_interface().get_base_control().get_icon("Button", "EditorIcons"))
	add_custom_type("GASVirtualButton", "Control", load("res://addons/gas/GASVirtualGamepad/GASVirtualButton.gd"), get_editor_interface().get_base_control().get_icon("Button", "EditorIcons"))
	add_custom_type("GASVirtualAnalogStick", "Control", load("res://addons/gas/GASVirtualGamepad/GASVirtualAnalogStick.gd"), get_editor_interface().get_base_control().get_icon("Button", "EditorIcons"))
	add_custom_type("GASVirtualDPad", "Control", load("res://addons/gas/GASVirtualGamepad/GASVirtualDPad.gd"), get_editor_interface().get_base_control().get_icon("Button", "EditorIcons"))
